...
func (c *CreateTableClient) Run() (*myQuery.CreateTableResult, error) {
    c.
        ...
        AppendColumnDefinition(
            myQuery.NewColumnDefinition(COL_PREFACE, "TEXT").
                SetComment("Preface")).
        AppendColumnDefinition(
            myQuery.NewColumnDefinition(COL_FOREWORD, "TEXT").
                SetComment("Foreword")).
        AppendColumnDefinition(
            myQuery.NewColumnDefinition(COL_ACKNOWLEDGMENTS, "TEXT").
                SetComment("Acknowledgements")).
        AppendColumnDefinition(
            myQuery.NewColumnDefinition(COL_AUTHOR_NOTE, "TEXT").
                SetComment("AuthorNote")).
        AppendColumnDefinition(
