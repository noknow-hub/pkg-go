...
//////////////////////////////////////////////////////////////////////
// Run by COL_URL and COL_LANG_CODE.
//////////////////////////////////////////////////////////////////////
func (c *DeleteClient) RunByUrlAndLangCode(url, langCode string) (*myQuery.DeleteResult, error) {
    c.BaseClient.WhereCondition.
        SetWhere(COL_URL, url).
        AppendAnd(COL_LANG_CODE, langCode)
    return c.BaseClient.Run()
}
