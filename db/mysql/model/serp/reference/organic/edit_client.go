...
// Run with all by "id".
//////////////////////////////////////////////////////////////////////
func (c *EditClient) RunWithAllById(currentId string, id, serpId, ranking, domain, url, title, groupRanking, timestamp, snippet, relatedUrl, cacheUrl *string) (*myQuery.UpdateResult, error) {
    if id != nil {
